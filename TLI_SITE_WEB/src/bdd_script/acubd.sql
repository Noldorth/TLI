...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mer. 16 oct. 2019 à 16:20
...
INSERT INTO `session` (`id_utilisateur`, `login`, `password`) VALUES
(1, 'admin', 'root');
...
('', '', 'jj', NULL),
('jj', 'jj', 'jj', NULL),
('maxence', 'bohard', 'max.bohard', NULL),
('maxence', 'bohard', 'max.bohard', NULL),
('maxence', 'bohard', 'max.bohard', NULL),
('maxence', 'bohard', 'max.bohard', NULL),
('maxence', 'bohard', 'max.bohard', NULL),
('k', 'jj', 'j', NULL),
('k', 'jj', 'j', NULL),
('jenaimarre', 'jenaimarre', 'jenaimarre', NULL),
('test', 'test', 'test', NULL),
('test', 'test', 'test', NULL),
('test', 'test', 'test', NULL),
('max', 'bohard', 'max', NULL),
('aa', 'aa', 'aa', NULL),
('aa', 'aa', 'aa', '$2y$10$cqtPAPQA.bEyDWmysYygXuYQ/qk74aeuDye9br.jJB1NaEznlgQry'),
('fuck', 'you', 'mother', '$2y$10$d5oxzLy0OEeiBQln2ryQk.OVAWMxkwZbAy6KJQTJrhskRywN3i35m'),
('gg', 'gg', 'gg', '$2y$10$lgkdmEWw3EzJGdxWGAcgOOFxK2301EGJCAHY7sM8ibo/43EhdDhTy');
COMMIT;
